            ...
            {!clientSecret ? (
              ...
              stripePromise && (
                <Elements stripe={stripePromise} options={{
                  ...
                  <PaymentForm paymentId={paymentId} successUrl={product.successUrl} amount={paymentAmount} currency={product.currency} brandName={brandName} legalName={product.legalName || ''} onAddPaymentInfo={() => trackEvent('AddPaymentInfo', { value: product.price, currency: product.currency, content_ids: [product.id] })} onBeforeConfirm={async () => {
                    if (!paymentId) return
